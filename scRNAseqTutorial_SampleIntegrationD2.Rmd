...
```{r}
# loading the samples
sce1 <- readRDS("~/Nextcloud2/Sampled_samples/sceD1.rds")

sce2 <- readRDS("~/Nextcloud2/Sampled_samples/sceD2.rds")

sce3 <- readRDS("~/Nextcloud2/Sampled_samples/sceD3.rds")
...
# exclude dimensionality reduction
...
clustvalue = pseudo$clustersCorrected
colData(pseudo) = NULL
colData(pseudo) <- asclustvalue
